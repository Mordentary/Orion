...
namespace Orion {
	...
	void OpenGLRendererAPI::CullBackFace(bool enabled) //TODO: REMOVE
	{
		if (enabled)
		glCullFace(GL_BACK);
		else
	...
	void OpenGLRendererAPI::DoFaceCulling(bool enable)
	{
		if (enable)
			glEnable(GL_CULL_FACE);
		else
	...
	void OpenGLRendererAPI::DoDepthTest(bool enabled)
	{
