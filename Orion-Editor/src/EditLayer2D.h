...
namespace Orion {
	...
	class EditLayer2D : public Orion::Layer
	{
	public:
		EditLayer2D() : Layer("Example") {}
		...
		void OnEvent(Orion::Event& event) override
		{
			...
			m_Dispatcher->Dispatch<Orion::KeyPressedEvent>(ORI_BIND_EVENT_FN(EditLayer2D::OnKeyPressed));
			m_Dispatcher->Dispatch<Orion::MouseMovedEvent>(ORI_BIND_EVENT_FN(EditLayer2D::OnMouseMoved));
		}
